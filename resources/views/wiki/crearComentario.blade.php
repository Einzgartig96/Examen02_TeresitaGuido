...
<div class="alert alert-danger">
    <strong>¡Vaya!</strong> Parece que hubo un problema al insertar el comentario.<br><br>
    <ul>
    ...
    <div class="card" style="width: 500px;" >
        <div class="card-body">
            ...
            <div class="col-lg-12 margin-tb" style="margin-top: 20px" >
                <form method="POST" action="{{route('comentarios.store')}}" class='formulario_wiki'>        
                    @csrf
                    <div class="form-group" align="center" >
                        ...
                        <div class="col-md-12 col-xl-12 col-sm-12" >
                            <label for="input_descripcion" class='label_form'>Comentario: </label>
                            <textarea style="resize:none" rows="5" cols="40">Deja aquí tu comentario</textarea>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary boton-form" style="margin-top: 20px">Agregar Comentario</button>
                </form>
            </div>
        </div>
    </div>
